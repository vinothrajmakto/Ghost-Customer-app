...
class PickuppointWidget extends StatefulWidget {
  ...
  @override
  _PickuppointWidgetState createState() => _PickuppointWidgetState();
}

class _PickuppointWidgetState extends State<PickuppointWidget> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _checkAndRequestLocation(); // Request GPS access and prompt to enable location
  }
    ...
    try {
      ...
      if (orderId != null) {
        ...
        await FirebaseFirestore.instance.collection('orders').doc(orderId).update({
          'PickuplatLng': GeoPoint(latLng.latitude, latLng.longitude),  // Store latLng as GeoPoint
        });
  ...
  Future<void> _confirmLocation() async {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => PickupaddressWidget(
